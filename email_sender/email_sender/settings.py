...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'replace_this_with_a_secure_random_string')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['TejasNYadav.pythonanywhere.com']
...
INSTALLED_APPS = [
    ...
    'emailapp',  # Replace with your app name
]
